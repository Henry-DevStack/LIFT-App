...
import { Check, LogOut, Palette, Pill, Plus, Trash2, Droplets } from "lucide-react";
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="bg-surface border border-border rounded-xl2 p-4">
          ...
          <button
            ...
            className="w-full bg-accent text-bg font-semibold py-3 rounded-xl2 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
          >
            {saved ? (
              <>
                <Check size={16} />
